...
const features = [
  {
    ...
    description: "Deep dive into the Malaysian public sector data ecosystem, and deeply understand agencies' core business.",
  },
  {
    title: "Data Engineering",
    description: "Build robust data pipelines to automate the publication of high-impact data at high speed and high granularity.",
  },
  {
    title: "Data Analytics",
    description: "Analyse data to uncover and present meaningful insights, making data.gov.my a valuable resource for the public.",
  },
  {
    title: "Data Science",
    description: "Apply statistical / ML techniques to solve operational problems in the handling of public sector data.",
  },
  {
    title: "DevOps",
    description: "Deploy and maintain scalable data infrastructure using modern cloud technologies and automation practices.",
  },
  {
    title: "Strategic Communications",
    description: "Effectively communicate data insights to stakeholders and the public through clear dataviz and compelling narratives.",
  }
];
  ...
  return (
    <main className="flex-1">
      ...
      <div className="relative">
        <motion.div 
          className="max-w-[1200px] mx-auto px-6 pt-24 pb-12"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <p className="text-xl dark:text-gray-400 text-gray-600 max-w-[600px]">
            Data engineering. Data analytics. Data science. All built on a deep understanding of Malaysian public sector data. These docs will help you shape public sector open data, hands-on!
          </p>
